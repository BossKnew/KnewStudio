...
const english: Record<string, string> = {
  ...
  '配置一个 OpenAI 兼容的大语言模型，用于润色文生图提示词。系统提示词留空时使用内置默认内容。': 'Configure an OpenAI-compatible language model for polishing text-to-image prompts. The built-in system prompt is used when the field is blank.',
  ...
  '保存设置': 'Save settings',
  '提示词润色设置已保存': 'Prompt polishing settings saved',
