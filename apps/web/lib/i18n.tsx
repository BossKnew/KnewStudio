...
const english: Record<string, string> = {
  ...
  '配置用于文生图和文生视频提示词润色的大语言模型。': 'Configure the language model used to polish text-to-image and text-to-video prompts.',
  ...
  'Wan 的 Base URL 只需填到 /api/v1，例如 https://dashscope.aliyuncs.com/api/v1 或 https://你的业务空间ID.cn-beijing.maas.aliyuncs.com/api/v1。不要带 video-synthesis，也不要使用 compatible-mode。文生视频模型 ID 填 wan2.7-t2v 或 wan2.7-t2v-2026-06-12，分辨率填 720P / 1080P。': 'For Wan, set Base URL only through /api/v1, such as https://dashscope.aliyuncs.com/api/v1 or https://YOUR_WORKSPACE_ID.cn-beijing.maas.aliyuncs.com/api/v1. Do not include video-synthesis, and do not use compatible-mode. Text-to-video model IDs are wan2.7-t2v or wan2.7-t2v-2026-06-12; resolutions are 720P / 1080P.',
  '供应商接口或模型不存在。Wan 的 Base URL 只需填到 /api/v1（例如 https://dashscope.aliyuncs.com/api/v1 或 https://{WorkspaceId}.cn-beijing.maas.aliyuncs.com/api/v1），不要带 video-synthesis，也不要使用 compatible-mode。文生视频模型 ID 应为 wan2.7-t2v 或 wan2.7-t2v-2026-06-12。': 'The Wan endpoint or model was not found. Set Base URL only through /api/v1 (https://dashscope.aliyuncs.com/api/v1 or https://{WorkspaceId}.cn-beijing.maas.aliyuncs.com/api/v1). Do not include video-synthesis and do not use compatible-mode. Text-to-video model IDs are wan2.7-t2v or wan2.7-t2v-2026-06-12.',
