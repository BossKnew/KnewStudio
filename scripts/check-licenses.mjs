...
// npm omits these MIT license fields from lockfile v3 metadata. Their
// package archives still include the license text; keep the exception narrow.
const approvedMissing = new Set(['node_modules/busboy', 'node_modules/seq-queue', 'node_modules/streamsearch']);
